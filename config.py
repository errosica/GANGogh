...
flags.DEFINE_string("data_dir", "/home/ubuntu/data/GANGoghData/images512TFR", "The data directory. Can be a google storage path (e.g. gs://my-bucket/my/path)")
...
flags.DEFINE_integer("z_dim", 512, "The z input dimension [1024]")
flags.DEFINE_integer("image_size", 512, "The width and height of the output images [1024]")
...
flags.DEFINE_float("gen_lr", 1e-5, "The generator learning rate [1e-4]")
...
flags.DEFINE_float("disc_lr", 1e-5, "The discriminator learning rate [1e-4]")
