...
flags.DEFINE_integer("lambda_penalty", 10)
flags.DEFINE_string("data_format", "NHWC", "The image data format to use. NCHW is recommended for GPU computations. [NHWC]")

flags.DEFINE_integer("gen_lr", 1e-5, "The generator learning rate")
flags.DEFINE_integer("disc_lr", 1e-4, "The discriminator learning rate")
